...
void l22::frame_size_calculator::do_var_declaration_node(l22::var_declaration_node * const node, int lvl) {
...
void l22::frame_size_calculator::do_func_definition_node(l22::func_definition_node * const node, int lvl) {
